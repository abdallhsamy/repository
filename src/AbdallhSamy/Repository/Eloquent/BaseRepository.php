<?php
namespace AbdallhSamy\Repository\Eloquent;
...
use AbdallhSamy\Repository\Contracts\RepositoryCriteriaInterface;
use AbdallhSamy\Repository\Contracts\RepositoryInterface;
use AbdallhSamy\Repository\Events\RepositoryEntityCreated;
use AbdallhSamy\Repository\Events\RepositoryEntityCreating;
use AbdallhSamy\Repository\Events\RepositoryEntityDeleted;
use AbdallhSamy\Repository\Events\RepositoryEntityDeleting;
use AbdallhSamy\Repository\Events\RepositoryEntityUpdated;
use AbdallhSamy\Repository\Events\RepositoryEntityUpdating;
use AbdallhSamy\Repository\Exceptions\RepositoryException;
use AbdallhSamy\Repository\Traits\ComparesVersionsTrait;
use Prettus\Validator\Contracts\ValidatorInterface;
use Prettus\Validator\Exceptions\ValidatorException;

/**
 * Class BaseRepository
 * @package AbdallhSamy\Repository\Eloquent
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of AbdallhSamy\\Repository\\Contracts\\PresenterInterface");
            }
     ...
     *
     * @return $this
     * @throws \AbdallhSamy\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of AbdallhSamy\\Repository\\Contracts\\CriteriaInterface");
        }
